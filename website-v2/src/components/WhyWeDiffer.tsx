  ...
  return (
    <section className="w-full px-xs py-2xl bg-white">
      <div className="w-full">
        ...
        <div className="bg-gradient-to-r from-black via-gray-900 to-black rounded-3xl mx-xs p-2xl text-center bg-leaves-4 bg-cover bg-center relative overflow-hidden">
